...
While I'm generating datasets I'm also populating the RSS feed.
...
for (datasetid in unique(records$dataset_id)) {
  ...
  file.remove(paste0("output/", shortname))
...
description <- "International Seabed Authority"
...
content <- paste0(paste0("<li><a href=\"", shortnames, "\">", shortnames, "</a></li>"), collapse = "\n")
