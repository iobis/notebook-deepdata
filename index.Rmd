...
Earlier versions of the file were encoded in the non-standard `ISO-8859-1`, requiring the need to use `readLines` before parsing the data with the jsonlite package, but that is fixed now.
...
Plotting the occurrence on a map reveals that some coordinates have issues:
